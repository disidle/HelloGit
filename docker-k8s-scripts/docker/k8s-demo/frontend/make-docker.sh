...
#docker tag frontend:$1 harbor.sanss.com/demo/frontend:$1

docker rmi harbor.sanss.com/demo/frontend:$1

docker build --tag "harbor.sanss.com/demo/frontend:$1" ./

echo '----upload image to harbor.sanss.com----'
docker push harbor.sanss.com/demo/frontend:$1
