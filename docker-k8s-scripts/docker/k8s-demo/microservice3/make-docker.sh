...
#docker build -t="demo-svc3:$1" ./
#docker tag demo-svc3:$1 harbor.sanss.com/demo/demo-svc3:$1

#docker rmi harbor.sanss.com/demo/demo-svc3:$1

docker build --tag  harbor.sanss.com/demo/demo-svc3:$1 ./


echo '----upload image to harbor.sanss.com----'
docker push harbor.sanss.com/demo/demo-svc3:$1
